...
function createNewChildren(children, props) {
  ...
  if (!children.length) {
    return isChildOfType(children, ["Geographies"]) ? _react["default"].cloneElement(children, {
      projection: props.projection
    }) : isChildOfType(children, ["Group", "Markers", "Lines", "Annotations", "Annotation", "Graticule"]) ? _react["default"].cloneElement(children, {
      projection: props.projection,
      zoom: props.zoom,
      width: props.width,
      height: props.height,
    ...
    return children.map(function (child, i) {
      if (!child) return;
      return isChildOfType(child, ["Geographies"]) ? _react["default"].cloneElement(child, {
        key: "zoomable-child-".concat(i),
        projection: props.projection
      }) : isChildOfType(child, ["Group", "Markers", "Lines", "Annotations", "Annotation", "Graticule"]) ? _react["default"].cloneElement(child, {
        key: "zoomable-child-".concat(i),
        projection: props.projection,
        zoom: props.zoom,
        width: props.width,
