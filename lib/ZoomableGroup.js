...
var ZoomableGroup = function (_Component) {
  ...
  _createClass(ZoomableGroup, [{
    ...
    value: function handleResize() {
      console.log('handleResize, this.props: ', this.props);
      var _props4 = this.props,
          width = _props4.width,
          height = _props4.height,
          projection = _props4.projection,
          zoom = _props4.zoom,
          parentWidth = _props4.parentWidth,
          parentHeight = _props4.parentHeight;


      var resizeFactorX = (0, _utils.calculateResizeFactor)(parentWidth, width);
      var resizeFactorY = (0, _utils.calculateResizeFactor)(parentHeight, height);
    ...
    value: function componentDidMount() {
      ...
      _reactNative.Dimensions.addEventListener("change", this.handleResize);
    ...
    value: function componentWillUnmount() {
      _reactNative.Dimensions.removeEventListener("change", this.handleResize);
