  ...
  _createClass(MapGroup, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(G, {
        className: "rsm-".concat(groupName),
        style: style
      }, !children ? null : children.length === undefined ? _react["default"].cloneElement(children, {
        projection: projection,
        zoom: zoom,
        width: width,
        height: height
      }) : children.map(function (child, i) {
        return !child ? null : _react["default"].cloneElement(child, {
          key: child.key || "".concat(itemName, "-").concat(i),
          projection: projection,
          zoom: zoom,
          width: width,
          height: height
