...
var Defs = _reactNativeSvg.Svg.Defs,
    G = _reactNativeSvg.Svg.G,
    Rect = _reactNativeSvg.Svg.Rect;
...
function (_Component) {
  ...
  _createClass(ComposableMap, [{
    ...
    value: function render() {
      ...
      }, defs && _react["default"].createElement(Defs, null, defs), _react["default"].cloneElement(this.props.children, {
        projection: this.projection(),
        width: width,
        height: height,
        parentHeight: this.state.parentHeight,
        parentWidth: this.state.parentWidth
      }), showCenter && _react["default"].createElement(G, null, _react["default"].createElement(Rect, {
        x: width / 2 - 0.5,
        y: 0,
        width: 1,
        height: height,
